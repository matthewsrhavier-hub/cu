...
<body>
    <div id="player-container">
        ...
        <div class="bottom-bar">
            ...
            <div class="controls-row">
                ...
                <button class="icon-btn" onclick="copyEmbed()" title="Código Embed"><i class="fas fa-code"></i></button>
    ...
    <script>
        ...
        function copyEmbed() {
            const embed = `<iframe src="${window.location.href}" width="100%" height="100%" frameborder="0" allowfullscreen allow="autoplay; picture-in-picture"></iframe>`;
            navigator.clipboard.writeText(embed).then(() => {
                alert("Código Embed copiado!");
            });
        }
...
async def watch():
    ...
    sub = request.args.get('sub', '') # Parâmetro para legenda externa
